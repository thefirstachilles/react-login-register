...
const ZoneMusic = () => {
    ...
    var audio=useRef(new Audio(MusicList[0].source))
    const playMusic=()=>{
        
       isTimerPlaying===true?setIsTimerPlaying(false):setIsTimerPlaying(true)
    }
    const addIndex=()=>{
    ...
    const resetPlayer=()=>{
        ...
        audio.current.src = MusicList[currentTrack].source
    ...
    const backImage=()=>{
        ...
        return {backgroundImage:"url("+MusicList[currentTrack].cover+")"}
    }
    return (
                    ...
                    <div className="player__top">
                        <div className="player-cover">
                            <div className="transitionName">
                                <div className="player-cover__item" style={backImage()}></div>
                            </div>
                        </div>
                        ...
                        <div className="player-controls">
                            ...
                            <a className="player-controls__item">
                                <svg className="icon">
                                    <use xlinkHref="#icon-link"></use>
                                </svg>
                            </a>

                            <div className="player-controls__item" onClick={minuIndex}>
                                <svg className="icon">
                                    <use xlinkHref="#icon-prev"></use>
                                </svg>
                            </div>

                            <div className="player-controls__item" onClick={addIndex}>
                                <svg className="icon">
                                    <use xlinkHref="#icon-next"></use>
                                </svg>
                            </div>

                            <div className="player-controls__item -xl js-play" onClick={playMusic}>
                                <svg className="icon">
                                    {isTimerPlaying ? <use xlinkHref="#icon-pause" ></use> : <use xlinkHref= "#icon-play"></use>}
                                </svg>
                            </div>
                        </div>
                    ...
                    <div className="progress" >
                        <div className="progress__top">
                            <div className="album-info" >
                                <div className="album-info__name">{MusicList[currentTrack].artist }</div>
                                <div className="album-info__track">{ MusicList[currentTrack].name }</div>
                            </div>
...
{/* 
                <a href="https://github.com/muhammederdem/mini-player" target="_blank" className="github-btn">
                    See on GitHub
                </a> */}

            </div>

            <svg xmlns="http://www.w3.org/2000/svg" hidden xmlnsXlink="http://www.w3.org/1999/xlink">
                <defs>
